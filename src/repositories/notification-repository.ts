  ...
  implements INotificationRepository
{
  ...
  async getUnreadCount(query: { recipientId: string; recipientRole: UserRole }): Promise<number> {
  ...
  async markAllRead(query: { recipientId: string; recipientRole: UserRole }): Promise<number> {
