...
let StripeController = class StripeController {
    constructor(_stripeService) {
        ...
        this.initiateStripeOnboarding = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const vendorId = req.user.id;
            const result = yield this._stripeService.createOnboardingLink(vendorId);
        ...
        this.getStripeOnboardingStatus = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const vendorId = req.user.id;
            const result = yield this._stripeService.getStripeOnboardingStatus(vendorId);
            const successResponse = {
                success: http_status_code_1.SUCCESS_STATUS.SUCCESS,
                message: messages_1.SUCCESS_MESSAGES.OK,
                data: result,
