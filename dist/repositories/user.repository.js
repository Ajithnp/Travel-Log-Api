...
let UserRepository = class UserRepository extends base_repository_1.BaseRepository {
    ...
    findByIdAndRemoveUnreadTabs(userId, tab) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.findByIdAndUpdate(userId, {
                $pull: {
                    unreadTabs: tab,
                },
            });
    ...
    findByIdAndAddUnreadTabs(userId, tab) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.findByIdAndUpdate(userId, {
                $addToSet: {
                    unreadTabs: tab,
    ...
    getUserUnreadTabs(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (user === null || user === void 0 ? void 0 : user.unreadTabs) || [];
        });
    }
};
