...
exports.PASSWORD_RESET = exports.WELCOME = exports.ACCOUNT_VERIFICATION = void 0;
const ACCOUNT_VERIFICATION = (otpCode, matter) => `
...
const PASSWORD_RESET = (name, resetLink) => `
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    <!-- Header -->
