...
exports.REDIRECT_URL = exports.NOTIFICATION_TITLES = exports.NOTIFICATION_MESSAGES = exports.ERROR_MESSAGES = exports.SUCCESS_MESSAGES = void 0;
...
exports.ERROR_MESSAGES = {
    ...
    // schedule-package
    SCHEDULE_TRIP_ATLEAST_SEVEN_DAYS_BEFORE: 'Trips must be scheduled at least 7 days before the start date',
    END_DATE_MUST_AFTER_START_DATE: 'End date must be after start date',
    CANNOT_SCHEDULE_TRIPS_FOUR_MONTH_IN_ADVANCE: 'Trips cannot be scheduled more than 4 months in advance',
    ...
    FAILED_TO_RESERVE_SEAT: 'Failed to reserve seats. They may have just been booked by someone else. Please try again.',
    PAYMENT_CONFIRMATION_FAILED: 'Payment initiation failed. Your booking has been cancelled and seats have been released. Please try again.',
...
exports.NOTIFICATION_MESSAGES = {
    ...
    CANCELLATION_REQUEST_APPROVED: (packageName, refundAmount) => `Your cancellation request for "${packageName}" has been approved. ₹${refundAmount} has been refunded to your wallet.`,
    USER_CANCELLATION_REJECTED: (packageName, rejectedReason) => `User booking for "${packageName}" has been rejected. admin noted : ${rejectedReason}`,
};
...
exports.REDIRECT_URL = {
    // user
    USER_BOOKING_DETAILS: (bookingId) => `/bookings/${bookingId}`,
};
